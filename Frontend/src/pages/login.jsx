...
const Login = () => {
    ...
    const SubmitHandler =async(data)=>{
        const res = await axios.post("http://localhost:3000/userapi/login",data )
        console.log(res);
                        ...
                        <div className="flex w-full lg:w-1/2 flex-1 flex-col items-center justify-center bg-background-light dark:bg-background-dark p-6">
                            <div className="w-full max-w-md flex flex-col gap-4">
                                ...
                                <form onSubmit={handleSubmit(SubmitHandler)} className="flex flex-col gap-4">
                                    {errors.email && <p className="text-red-500 text-sm"> Enter your Username</p>}
                                    <label className="flex flex-col w-full">
                                        <p className="text-[#111618] dark:text-gray-200 pb-2 font-medium">Username</p>
                                        <input
                                            type="text"
                                    ...
                                    {/* Password Input */}
                                    {errors.password && <p className="text-red-500 text-sm">Enter your password</p>}
                                    <label className="flex flex-col w-full">
